        ...
        {#if overlayContent === 'agreement'}
          <div class="space-y-4">
            <section>
              ...
              <p>本网站（以下简称"本站"）由Undefined SS Community运营。联系邮箱：<a href="mailto:smfsheng@qq.com" class="text-primary underline">smfsheng@qq.com</a></p>
              <p>本站服务器位于美国，中国大陆 ICP 备案处于申请流程。本站无意针对中国大陆用户提供服务，但由于互联网的开放性，中国大陆用户可能通过合法渠道访问本站。你理解并同意，本站运营者暂未主动向中国大陆市场提供服务，也不以中国大陆为目标市场。</p>
            </section>

            <section>
              <h3 class="font-bold text-base mb-2">免责声明</h3>
              <p>本站是一个社区项目，按「现状」及「可用」基础提供。在法律允许的最大范围内，本站明确声明不承担任何明示或暗示的担保责任，包括但不限于适销性、特定用途适用性及不侵权的担保。本站不保证服务的连续性、及时性、安全性及准确性，你使用本站服务所产生的全部风险由你自行承担。</p>
            ...
            <section>
              <h3 class="font-bold text-base mb-2">【暂未开放】论坛使用规则</h3>
        ...
        {:else}
          <div class="space-y-4">
            <section>
              ...
              <ol class="list-decimal list-inside space-y-1">
                <li><strong>账号信息：</strong>注册时你提供的用户名、邮箱地址及头像。（当前阶段暂未开放注册功能）</li>
            ...
            <section>
              ...
              <p>【暂未开放】你生成的内容（包括图片及提示词）存储在本站运营者控制的服务器上。我们采取合理的技术措施保护你的数据安全，但互联网传输无法保证绝对安全。论坛账号密码经过加密存储，但我们建议你不要在多个站点使用相同的密码。</p>
            </section>
